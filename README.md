All files needed for exact hardware build. Works with Sequoia and Tahoe Public Beta. Includes USB map works in both Sequoia and Tahoe. Place all files in a new folder named EFI.
